...
-- 触发器 1：在订单写入明细前，强制阻断超卖或下架商品的下单 (答辩核心亮点)
...
-- -----------------------------------------------------------------
-- 6. 数据可视化专属：多维度业务决策视图 (Views For Streamlit)
-- -----------------------------------------------------------------
...
('张三', '13800138001', '1期5栋', 'A302', 250.00),
('李四', '13800138002', '1期5栋', 'B511', 15.00),
('王五', '13800138003', '2期12栋', '404', 500.00);

INSERT INTO merchants (merchant_name, phone, address, rating) VALUES
('一号黄焖鸡米饭', '17711112222', '丁香餐厅一楼3号档口', 4.8),
('川湘木桶饭', '17711113333', '玫瑰餐厅二楼核心区', 4.6),
('蜜雪冰城校园店', '17711114444', '下沉广场天桥旁', 4.9);
...
('王大锤', '15599992222', 'Stage1_Trunk', 'Idle'),
('李大力', '15599994444', 'Stage1_Trunk', 'Idle'),
('周小飞', '15599995555', 'Stage1_Trunk', 'Idle'),
('刘强东', '15599996666', 'Stage1_Trunk', 'Idle'),
('吴勇军', '15599997777', 'Stage1_Trunk', 'Idle'),
('郑明达', '15599998888', 'Stage1_Trunk', 'Idle'),
('黄启航', '15599999999', 'Stage1_Trunk', 'Idle'),
('牛干劲', '15599993333', 'Stage2_Floor', 'Idle'),
('马小跳', '15611111111', 'Stage2_Floor', 'Idle'),
('林志远', '15611112222', 'Stage2_Floor', 'Idle'),
('张小凡', '15611113333', 'Stage2_Floor', 'Idle'),
('陈奕迅', '15611114444', 'Stage2_Floor', 'Idle'),
('李逍遥', '15611115555', 'Stage2_Floor', 'Idle'),
('赵灵儿', '15611116666', 'Stage2_Floor', 'Idle');
